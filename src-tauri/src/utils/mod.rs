...
impl AppConfig {
    pub fn from_env() -> Result<Self, String> {
        ...
        let is_dev = std::env::var("DEV_ENV")
            .unwrap_or_else(|_| "3.0.2".to_string())
            .parse::<bool>()
            .unwrap_or(false);
    ...
    fn from_runtime_env() -> Result<Self, String> {
        ...
        let api_version =
            std::env::var("SHOPIFY_API_VERSION").unwrap_or_else(|_| "3.0.2".to_string());
        ...
        // App Configuration
        let version = std::env::var("VERSION").unwrap_or_else(|_| "3.0.2".to_string());
    ...
    fn from_compile_time_env() -> Result<Self, String> {
        ...
        // App Configuration
        let version = option_env!("VERSION").unwrap_or("3.0.2").to_string();
